...
**核心算法模块**：
- v1.0-v5.0: 知识点切分、标注、知识图谱构建、难点识别、学习路径生成等核心功能
- v6.0-v10.0: 25个新功能模块已完成（89.3%），包括置信度门控、干预抗震荡、认知步频计算、学习风格自适应等
...
- [开发规范](docs/开发规范.md)
- [算法模块README](algorithm/README.md) - AI算法模块详细说明
- [v6-v10功能实现总结](algorithm/v6-v10_功能实现总结.md) - 新功能模块实现进度
